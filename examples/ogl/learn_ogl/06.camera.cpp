...
int main(int argc, char** argv) {
	...
	// ------------------------------------
	std::string vertex_shader_path = assets_path + "/shaders/learnogl/coord.vert";
	std::string fragment_shader_path = assets_path + "/shaders/learnogl/coord.frag";
	sail::demo::GLShader ourShader{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		ourShader.set_mat4("projection", glm::value_ptr(projection));

		// camera/view transformation
		glm::mat4 view = glm::lookAt(cameraPos, cameraPos + cameraFront, cameraUp);
		ourShader.set_mat4("view", glm::value_ptr(view));
		...
		for (unsigned int i = 0; i < 10; i++) {
			...
			ourShader.set_mat4("model", glm::value_ptr(model));
