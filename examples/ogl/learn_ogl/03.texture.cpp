...
int main(int argc, char** argv) {
	...
	// load shader
	// -----------
	std::string vertex_shader_path = assets_path + "/shaders/learnogl/texture.vert";
	std::string fragment_shader_path = assets_path + "/shaders/learnogl/texture.frag";
	GLShader shader{
